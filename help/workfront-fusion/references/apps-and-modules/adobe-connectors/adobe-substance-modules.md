---
title: Módulos do Adobe Substance
description: Em um cenário do Adobe Workfront Fusion, é possível automatizar fluxos de trabalho que usam  [!DNL Adobe Substance], bem como conectá-lo a vários aplicativos e serviços de terceiros.
author: Becky
...
Em um cenário do Adobe Workfront Fusion, é possível automatizar fluxos de trabalho que usam [!DNL Adobe Substance], bem como conectá-lo a vários aplicativos e serviços de terceiros.
...
## Módulos do [!DNL Adobe Substance] e seus campos

Ao configurar módulos do [!DNL Adobe Substance], o Workfront Fusion exibe os campos listados abaixo. Junto com eles, outros campos do [!DNL Adobe Substance] podem ser exibidos, dependendo de fatores como seu nível de acesso no aplicativo ou serviço. Um asterisco ao lado do nome do campo em um módulo indica um campo obrigatório.
