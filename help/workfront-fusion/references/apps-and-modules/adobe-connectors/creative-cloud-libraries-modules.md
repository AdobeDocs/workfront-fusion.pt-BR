---
title: Módulos de bibliotecas da Adobe Creative Cloud
description: Com os módulos de Bibliotecas [!DNL Adobe Workfront Fusion Adobe Creative Cloud], é possível iniciar um cenário quando um elemento ou biblioteca é criado ou atualizado. Você também pode carregar, recuperar, arquivar ou listar elementos, ou fazer uma chamada para a API [!DNL Adobe Creative Cloud Libraries].
author: Becky
...
Ao configurar módulos do [!UICONTROL Adobe Creative Cloud Libraries], o Workfront Fusion exibe os campos listados abaixo. Junto com eles, outros campos do [!DNL Adobe Creative Cloud Libraries] podem ser exibidos, dependendo de fatores como seu nível de acesso no aplicativo ou serviço. Um título em negrito em um módulo indica um campo obrigatório.
...
<table style="table-layout:auto"> 
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>Adicione a consulta para a chamada de API na forma de um objeto JSON padrão.</p>
