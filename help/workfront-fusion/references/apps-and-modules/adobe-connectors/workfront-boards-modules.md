...
1. Em qualquer módulo [!DNL Adobe Workfront Boards], clique em **[!UICONTROL Add]** ao lado da caixa Conexão.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Selecione o método de solicitação HTTP necessário para configurar a chamada de API. Para obter mais informações, consulte <a href="/help/workfront-fusion/references/modules/http-request-methods.md" class="MCXref xref" data-mc-variable-override="">Métodos de solicitação HTTP em [!DNL Adobe Workfront Fusion]</a>.</p><p>Para a maioria das chamadas de placas, o método é POST. </td> 
  </tr> 
  <tr> 
