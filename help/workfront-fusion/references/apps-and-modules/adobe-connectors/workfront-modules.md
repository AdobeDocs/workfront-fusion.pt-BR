   ...
   <table style="table-layout:auto"> 
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <p>Insira o nome da sua instância, também conhecido como domínio.</p><p>Exemplo: se a URL for <code>https://example.my.workfront.com</code>, digite <code>example</code>.</p>
        </td>
      </tr>
      <tr>
