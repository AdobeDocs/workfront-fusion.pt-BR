...
1. Preencha os seguintes campos:
   ...
   <table style="table-layout:auto"> 
      ...
      <tbody>
        ...
        <td>Insira seu [!DNL Adobe] [!UICONTROL Technical account ID]. Isso pode ser encontrado na seção de detalhes [!UICONTROL Credentials] do [!DNL Adobe Developer Console]</td>
        </tr>
        <tr>
        ...
        <td>
          ...
          <ol>
            ...
            <li value="5">
              <p>Clique em <b>Salvar</b> para extrair o arquivo e retornar à configuração de conexão[!UICONTROL ]e.</p>
            </li>
          </ol>
        </td>
        </tr>
