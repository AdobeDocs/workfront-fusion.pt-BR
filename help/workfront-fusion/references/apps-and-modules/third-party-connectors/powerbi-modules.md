...
>[!NOTE]
>
>O Workfront Fusion não é uma fonte de dados. Embora o Workfront Fusion possa criar e usar fontes de dados, ele não armazena seus dados.
...
## Módulos do [!DNL Power BI] e seus campos

Ao configurar o [!DNL Power BI], o Workfront Fusion exibe os campos listados abaixo. Junto com eles, outros campos podem ser exibidos, dependendo de fatores como seu nível de acesso no aplicativo ou serviço. Um título em negrito em um módulo indica um campo obrigatório.
