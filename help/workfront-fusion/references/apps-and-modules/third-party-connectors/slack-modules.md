...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Insira (mapeie) a ID do canal.</p> <p>Observação: a ID do Canal pode ser recuperada usando o módulo [!UICONTROL List Channels].</p> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Escolha como deseja selecionar o canal no qual deseja criar uma mensagem.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>No campo <strong>[!UICONTROL Channel ID or name]</strong>, insira ou mapeie a ID do canal ou o nome do canal em que deseja postar a mensagem.</p> <p>Observação: a ID do Canal pode ser recuperada usando o módulo [!UICONTROL List Channels].</p> </li> 
     <li> <p><strong>[!UICONTROL Select from the list]</strong> </p> <p>Selecione o tipo de canal e, em seguida, selecione o canal.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Selecione <strong>[!UICONTROL Yes]</strong> se ambas as condições a seguir se aplicarem:</p> 
    <ul> 
  ...
  <tr> 
   ...
   <td> <p>Ative esta opção para permitir a análise automática. </p> <p>Para obter mais informações, consulte <a href="https://api.slack.com/docs/formatting">Formatação de texto para superfícies do aplicativo</a> na documentação de [!DNL Slack].</p> <p>Observação: se você usou as opções [!UICONTROL Link names] ou [!UICONTROL Parse message text] na mensagem original, especifique-as ao executar o módulo [!UICONTROL Update a Message] também.</p> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Escolha como você deseja selecionar a mensagem.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>No campo <strong>[!UICONTROL Channel ID or name]</strong>, insira ou mapeie a ID do Canal ou do canal que contém a mensagem e, em seguida, insira a <strong>[!UICONTROL Time Stamp (Message ID)]</strong> da mensagem. .</p> <p>Observação: a ID do Canal pode ser recuperada usando o módulo [!UICONTROL List Channels].</p> </li> 
     <li> <p><strong>[!UICONTROL Select from the list]</strong> </p> <p>Selecione o tipo de canal, o canal e a mensagem.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Text]</p> </td> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Parse message text]</p> </td> 
   <td> <p>Ative esta opção para permitir a análise automática. </p> <p> Para obter mais informações, consulte <a href="https://api.slack.com/docs/formatting">Formatação de texto para superfícies do aplicativo</a> na documentação de [!DNL Slack].</p> <p>Observação: se você usou as opções [!UICONTROL Link names] ou [!UICONTROL Parse message text] na mensagem original, também deverá especificá-las ao executar o módulo Atualizar uma Mensagem.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Channel ID]</p> </td> 
   <td> <p>Insira ou mapeie a ID do canal sobre o qual deseja recuperar informações.</p> <p>Observação: a ID do Canal pode ser recuperada usando o módulo [!UICONTROL List Channels].</p> </td> 
  </tr> 
 </tbody> 
</table>
...
* **Canal privado**: anteriormente [!UICONTROL Group]
* **Mensagem direta**: anteriormente [!UICONTROL IM]
* **Canal**: [!UICONTROL Conversation] na documentação da API, [!UICONTROL channel] no aplicativo [!DNL Slack].
