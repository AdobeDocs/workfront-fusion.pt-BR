...
# Módulos do [!DNL OpenAI (ChatGPT & DALL-E)]

Em um cenário do Adobe Workfront Fusion, é possível automatizar fluxos de trabalho que usam [!DNL OpenAI (ChatGPT & DALL-E)], bem como conectá-lo a vários aplicativos e serviços de terceiros.
...
## Conectando o [!DNL OpenAI (ChatGPT & DALL-E)] ao Workfront Fusion
...
## Módulos do [!DNL OpenAI (ChatGPT & DALL-E)] e seus campos

Ao configurar módulos do [!DNL OpenAI (ChatGPT & DALL-E)], o Workfront Fusion exibe os campos listados abaixo. Junto com eles, outros campos do [!DNL OpenAI (ChatGPT & DALL-E)] podem ser exibidos, dependendo de fatores como seu nível de acesso no aplicativo ou serviço. Um título em negrito em um módulo indica um campo obrigatório.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">[!UICONTROL Connection]</td> 
   <td> <p>Para obter instruções sobre como conectar sua conta do [!DNL OpenAI (ChatGPT & DALL-E)] ao Workfront Fusion, consulte <a href="#connecting-openaichatgpt-to-workfront-fusion" class="MCXref xref">Conectando o [!DNL OpenAI (ChatGPT & DALL-E)] ao Workfront Fusion</a> neste artigo.</p> </td> 
  </tr> 
  <tr> 
