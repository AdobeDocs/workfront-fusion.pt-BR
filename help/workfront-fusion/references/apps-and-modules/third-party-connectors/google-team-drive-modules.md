...
Em um cenário do Adobe Workfront Fusion, é possível automatizar fluxos de trabalho que usam [!DNL Google Team Drive], bem como conectá-lo a vários aplicativos e serviços de terceiros.
...
## Módulos do [!DNL Google Team Drive] e seus campos

Ao configurar módulos do [!DNL Google Team Drive], o Workfront Fusion exibe os campos listados abaixo. Junto com eles, outros campos do [!DNL Google Team Drive] podem ser exibidos, dependendo de fatores como seu nível de acesso no aplicativo ou serviço. Um título em negrito em um módulo indica um campo obrigatório.
