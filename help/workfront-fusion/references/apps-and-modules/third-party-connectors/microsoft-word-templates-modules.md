---
title: Módulos de modelos do Microsoft Word
...
# Módulos do [!DNL Microsoft Word Template]

Em um cenário do Adobe Workfront Fusion, é possível automatizar fluxos de trabalho que usam [!DNL Microsoft Word Templates], bem como conectá-lo a vários aplicativos e serviços de terceiros.
...
Para usar o [!DNL Miscrosoft Word Templates] com o Adobe Workfront Fusion, é necessário ter uma conta [!DNL Office 365]. Você pode criar um em `www.office.com`.



## Conectando o serviço [!DNL Office] ao Workfront Fusion
