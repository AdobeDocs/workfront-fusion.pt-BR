...
Algumas linhas contêm informações denominadas “Novo” e “Atual”. Isso ocorre porque a Workfront está fazendo a transição para um novo modelo de preços e pacotes, com algumas organizações operando com o novo modelo e outras ainda usando o modelo atual. Para descobrir qual modelo sua organização usa, entre em contato com o administrador do Workfront. Você pode encontrar detalhes e links para informações na seção [Tabela de requisitos de acesso](#the-access-requirements-table) deste artigo.

>[!NOTE]
>
>Se tiver dúvidas sobre como qualquer um dos campos desta tabela se aplica a você, entre em contato com o administrador do Workfront Fusion.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> As licenças do Adobe Workfront referem-se ao conjunto de recursos do Workfront incluídos na licença atribuída a você. Por exemplo, um usuário pode ter uma licença que inclui a marcação de itens de trabalho como concluídos e o tempo de registro em log, enquanto outro usuário tem uma licença que permite apenas aprovar ativos ou enviar solicitações. <p> 
   <ul>
  ...
  <tr> 
   ...
   <td>Em alguns casos, o Fusion deve ser adquirido além do Workfront. Se a sua organização tiver o pacote Ultimate Workfront, o Fusion estará incluído.
  <tr> 
  ...
  <tr> 
   ...
   <li>Legado: as licenças herdadas se baseiam na capacidade dos cenários de se conectarem a aplicativos de terceiros ou se os cenários são usados apenas para automação do Workfront. </li>
   </ul>
