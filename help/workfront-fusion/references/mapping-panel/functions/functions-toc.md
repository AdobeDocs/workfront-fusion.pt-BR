...
title: 'Referências de funções: índice do artigo'
description: Esta seção contém material de referência relacionado às funções no Adobe Workfront Fusion.
author: Becky
...
# Referências de funções: índice do artigo
