...
* Introdução ao Workfront Fusion {#get-started-with-fusion}
   ...
   * Entender o Workfront Fusion {#understand-workfront-fusion}
      ...
      * [Visão geral das APIs no Fusion](/help/workfront-fusion/get-started-with-fusion/understand-fusion/api-overview.md)
...
* Configurar e gerenciar o Workfront Fusion {#set-up-and-manage-fusion}
   ...
   * Configurar e gerenciar organizações e equipes {#set-up-and-manage-orgs-and-teams}
      ...
      * Configurar organizações e equipes {#set-up-orgs-teams-and-users}
         ...
         * [Configurar endereços IP para o Fusion no incluo na lista de permissões de sua organização](/help/workfront-fusion/set-up-and-manage-workfront-fusion/set-up-and-manage-orgs-and-teams/set-up-orgs-teams-and-users/set-up-ip-addresses-for-fusion.md)
