...
>[!NOTE]
>
>Em vez de copiar um grupo de módulos, você pode mover um grupo de módulos para um novo cenário encadeado. Para obter instruções, consulte [Mover módulos para uma cadeia](/help/workfront-fusion/manage-scenarios/move-modules-to-a-chain.md).
