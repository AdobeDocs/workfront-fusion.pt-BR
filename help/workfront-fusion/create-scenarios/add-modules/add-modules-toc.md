...
title: 'Adicionar módulos: índice do artigo'
description: Esta seção contém artigos relacionados à adição de módulos no Workfront Fusion.
author: Becky
...
# Adicionar módulos: índice do artigo

* [Adicionar módulo a um cenário](/help/workfront-fusion/create-scenarios/add-modules/add-a-module-basic.md)
...
* [Adicionar um prompt de IA ao seu cenário](/help/workfront-fusion/create-scenarios/add-modules/add-an-ai-prompt-to-your-scenario.md)
...
* [Adicionar um módulo Roteador e configurar rotas](/help/workfront-fusion/create-scenarios/add-modules/router-module.md)
* [Adicionar filtro a um cenário](/help/workfront-fusion/create-scenarios/add-modules/add-a-filter-to-a-scenario.md)
