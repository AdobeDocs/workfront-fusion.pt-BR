...
title: Gerenciar cenários na área Cenários
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Você deve ser um administrador do Fusion para atribuir um cenário a um pool de trabalhadores. </td>
   </tr>
 </tbody> 
</table>
...
## Exibir e gerenciar cenários na área Cenários
...
1. Para mover um ou mais cenários para uma pasta, clique na caixa de seleção ao lado de cada cenário que deseja mover e clique em **Mover para Pasta** na barra na parte inferior da tela. Na janela exibida, selecione a pasta para a qual deseja mover os cenários e clique em **Mover**.
