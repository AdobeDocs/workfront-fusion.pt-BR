...
title: 'Gerenciar cenários: índice do artigo'
...
# Gerenciar cenários: índice do artigo
...
* [Exibir histórico de execuções de um cenário](/help/workfront-fusion/manage-scenarios/view-scenario-execution-history.md)
* [Exibir execução de um cenário específico](/help/workfront-fusion/manage-scenarios/view-a-specific-scenario-execution.md)
...
* [Editar Webhooks](/help/workfront-fusion/manage-scenarios/edit-webhooks.md)
* [Acionar novamente a execução de um cenário](/help/workfront-fusion/manage-scenarios/retrigger-specific-execution.md)
* [Usar Executar uma vez para testar um cenário](/help/workfront-fusion/manage-scenarios/run-once.md)
* [Restaurar um cenário excluído](/help/workfront-fusion/manage-scenarios/restore-deleted-scenario.md)
