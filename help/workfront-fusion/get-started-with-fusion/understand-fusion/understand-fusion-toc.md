...
title: 'Noções básica do Workfront Fusion: índice do artigo'
description: Esta seção contém artigos que ajudam você a entender o Adobe Workfront Fusion.
author: Becky
...
# Noções básicas do Fusion: índice do artigo
...
* [Visão geral de APIs no Fusion](/help/workfront-fusion/get-started-with-fusion/understand-fusion/api-overview.md)
