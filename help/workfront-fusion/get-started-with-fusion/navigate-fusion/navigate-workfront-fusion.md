...
| Visão geral da equipe <br> ![Ícone da equipe](assets/team-icon.png) | Aqui, você pode ver informações sobre as equipes do Fusion, como o número de operações executadas por cenários nessa equipe e uma lista de cenários ativos. Você também pode exibir e gerenciar os usuários nesta equipe. Ao visualizar uma equipe, você pode selecionar uma equipe diferente em uma lista suspensa na parte superior desta página.<br>A equipe selecionada no momento aparece acima deste ícone.<br>Talvez seja necessário criar uma equipe antes de ver a visão geral de equipe ou qualquer uma das seções de equipe listadas neste artigo. | [Organizações e equipes](/help/workfront-fusion/set-up-and-manage-workfront-fusion/set-up-and-manage-orgs-and-teams/set-up-orgs-teams-and-users/org-and-team-overview.md) |
