...
Esta página descreve todos os aprimoramentos realizados no Adobe Workfront Fusion na semana de terça-feira, 12 de maio de 2025.
...
Para obter instruções sobre como configurar a autorização de certificados no conector DevOps do Azure, consulte [Conectar [!DNL Azure DevOps] ao Workfront Fusion](/help/workfront-fusion/references/apps-and-modules/third-party-connectors/azure-dev-ops.md#connect-azure-devops-to-workfront-fusion) no artigo Módulos DevOps do Azure.
