...
Esta página descreve todos os aprimoramentos realizados no Adobe Workfront Fusion na semana de terça-feira, 18 de agosto de 2025.
...
Para facilitar a depuração ou o compartilhamento da configuração do módulo, tornamos possível criar um link para um módulo específico em um cenário.Para criar um link para um módulo específico, adicione `?moduleId=<module-id>` à URL ao visualizar as seguintes páginas:
