...
## O Scenario Debugger agora está disponível na experiência unificada do Adobe

Disponibilizamos o Scenario Debugger como parte do Fusion Devtool na Adobe Unified Experience. Agora, os usuários que acessam o Fusion por meio do Adobe podem usar o Debugger para solucionar problemas de cenários complexos. O Debugger exibe o histórico das execuções do cenário e permite que você pesquise os módulos pelo nome ou ID.
