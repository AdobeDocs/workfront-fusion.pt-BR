...
Para criar uma experiência mais consistente com outros produtos da Adobe, disponibilizamos o Workfront Fusion pelo Adobe Unified Shell. Agora, você pode encontrar o Workfront Fusion no painel da Adobe Experience Cloud e alternar entre o Fusion como faria com qualquer outro produto da Adobe Experience Cloud.
...
## Funcionalidade de gerenciamento de usuários do Workfront Fusion atualizada para usuários do Adobe Business Platform

Se sua organização foi integrada à Adobe Business Platform, os usuários são gerenciados por meio da Adobe Admin Console. Portanto, removemos a funcionalidade de gerenciamento de usuários das contas do Workfront Fusion de organizações que foram integradas à Adobe Business Platform. Isso inclui o seguinte:
