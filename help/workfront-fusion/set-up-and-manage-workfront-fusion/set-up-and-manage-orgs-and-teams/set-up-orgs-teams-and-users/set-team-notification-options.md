---
title: Definir opções de notificação da equipe
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td><p>Receba um email quando um cenário for desativado.</p><p>Em alguns casos, um cenário pode ser desativado pela equipe de engenharia do Workfront Fusion porque está causando desempenho ou outros problemas. Nesses casos, você não recebe notificações no Workfront Fusion. </p></td>
