...
title: 'Configurar organizações, equipes e usuários: índice de artigos'
description: Esta seção contém artigos relacionados à configuração de organizações e equipes e equipes no Adobe Workfront Fusion.
author: Becky
...
# Configurar organizações, equipes e usuários: índice de artigos
...
* [Configurar endereços IP do Fusion na lista de permissões de sua organização](/help/workfront-fusion/set-up-and-manage-workfront-fusion/set-up-and-manage-orgs-and-teams/set-up-orgs-teams-and-users/set-up-ip-addresses-for-fusion.md)
